...
export default async function EditCoursePage({
  ...
  const editCourseAction = async (formData: FormData) => {
    'use server'
        ...
        <header className="space-y-3 mb-8">
          ...
          <div>
            ...
            <p className="mt-2 text-sm sm:text-base text-gray-400">
              기존에 등록한 학습 정보를 수정할 수 있습니다.
            </p>
          </div>
        </header>

        {/* 입력 폼 */}
        <form action={editCourseAction} className="card-min p-6 space-y-5">
